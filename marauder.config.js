module.exports = {
    ...
    zip_config_name: "kandian", //控制发包的json文件名
        sw: true,
    sw_config: {
        cacheId: 'sina-home-lolita',
        minify: true,
        sinaGlobalPrefix: 'https://mjs.sinaimg.cn/wap/project/lolita/',
        staticFileGlobsIgnorePatterns: [/\.debug\.js$/, /\.chunk\.js$/,/dependencyGraph\.json$/, /\.map$/]
    }
}
